...
#if LINUX
// The linux library uses uint, not ulong, for some reason
using LargeUInt = uint;
#else
using LargeUInt = ulong;
#endif
...
public static class SimpleITKExtensionMethods
{
   ...
   public static SITKImage FFTNormalizedCorrelation(this SITKImage fixedImage, SITKImage movingImage, LargeUInt requiredNumberOfOverlappingPixels) => SimpleITK.FFTNormalizedCorrelation(fixedImage, movingImage, requiredNumberOfOverlappingPixels);
   public static SITKImage FFTNormalizedCorrelation(this SITKImage fixedImage, SITKImage movingImage, LargeUInt requiredNumberOfOverlappingPixels, double requiredFractionOfOverlappingPixels) => SimpleITK.FFTNormalizedCorrelation(fixedImage, movingImage, requiredNumberOfOverlappingPixels, requiredFractionOfOverlappingPixels);
   ...
   public static SITKImage LabelMapMask(this SITKImage labelMapImage, SITKImage featureImage, LargeUInt label) => SimpleITK.LabelMapMask(labelMapImage, featureImage, label);
   public static SITKImage LabelMapMask(this SITKImage labelMapImage, SITKImage featureImage, LargeUInt label, double backgroundValue) => SimpleITK.LabelMapMask(labelMapImage, featureImage, label, backgroundValue);
   public static SITKImage LabelMapMask(this SITKImage labelMapImage, SITKImage featureImage, LargeUInt label, double backgroundValue, bool negated) => SimpleITK.LabelMapMask(labelMapImage, featureImage, label, backgroundValue, negated);
   public static SITKImage LabelMapMask(this SITKImage labelMapImage, SITKImage featureImage, LargeUInt label, double backgroundValue, bool negated, bool crop) => SimpleITK.LabelMapMask(labelMapImage, featureImage, label, backgroundValue, negated, crop);
   public static SITKImage LabelMapMask(this SITKImage labelMapImage, SITKImage featureImage, LargeUInt label, double backgroundValue, bool negated, bool crop, VectorUInt32 cropBorder) => SimpleITK.LabelMapMask(labelMapImage, featureImage, label, backgroundValue, negated, crop, cropBorder);
   ...
   public static SITKImage LabelVoting(this SITKImage image1, SITKImage image2, SITKImage image3, SITKImage image4, SITKImage image5, LargeUInt labelForUndecidedPixels) => SimpleITK.LabelVoting(image1, image2, image3, image4, image5, labelForUndecidedPixels);
   public static SITKImage LabelVoting(this SITKImage image1, SITKImage image2, SITKImage image3, SITKImage image4, LargeUInt labelForUndecidedPixels) => SimpleITK.LabelVoting(image1, image2, image3, image4, labelForUndecidedPixels);
   public static SITKImage LabelVoting(this SITKImage image1, SITKImage image2, SITKImage image3, LargeUInt labelForUndecidedPixels) => SimpleITK.LabelVoting(image1, image2, image3, labelForUndecidedPixels);
   public static SITKImage LabelVoting(this SITKImage image1, SITKImage image2, LargeUInt labelForUndecidedPixels) => SimpleITK.LabelVoting(image1, image2, labelForUndecidedPixels);
   public static SITKImage LabelVoting(this SITKImage image1, LargeUInt labelForUndecidedPixels) => SimpleITK.LabelVoting(image1, labelForUndecidedPixels);
   public static SITKImage LabelVoting(this VectorOfImage images) => SimpleITK.LabelVoting(images);
   public static SITKImage LabelVoting(this VectorOfImage images, LargeUInt labelForUndecidedPixels) => SimpleITK.LabelVoting(images, labelForUndecidedPixels);
   ...
   public static SITKImage MaskedFFTNormalizedCorrelation(this SITKImage fixedImage, SITKImage movingImage, SITKImage fixedImageMask, SITKImage movingImageMask, LargeUInt requiredNumberOfOverlappingPixels) => SimpleITK.MaskedFFTNormalizedCorrelation(fixedImage, movingImage, fixedImageMask, movingImageMask, requiredNumberOfOverlappingPixels);
   public static SITKImage MaskedFFTNormalizedCorrelation(this SITKImage fixedImage, SITKImage movingImage, SITKImage fixedImageMask, SITKImage movingImageMask, LargeUInt requiredNumberOfOverlappingPixels, float requiredFractionOfOverlappingPixels) => SimpleITK.MaskedFFTNormalizedCorrelation(fixedImage, movingImage, fixedImageMask, movingImageMask, requiredNumberOfOverlappingPixels, requiredFractionOfOverlappingPixels);
   ...
   public static SITKImage MultiLabelSTAPLE(this SITKImage image1, SITKImage image2, SITKImage image3, SITKImage image4, SITKImage image5, LargeUInt labelForUndecidedPixels) => SimpleITK.MultiLabelSTAPLE(image1, image2, image3, image4, image5, labelForUndecidedPixels);
   public static SITKImage MultiLabelSTAPLE(this SITKImage image1, SITKImage image2, SITKImage image3, SITKImage image4, SITKImage image5, LargeUInt labelForUndecidedPixels, float terminationUpdateThreshold) => SimpleITK.MultiLabelSTAPLE(image1, image2, image3, image4, image5, labelForUndecidedPixels, terminationUpdateThreshold);
   public static SITKImage MultiLabelSTAPLE(this SITKImage image1, SITKImage image2, SITKImage image3, SITKImage image4, SITKImage image5, LargeUInt labelForUndecidedPixels, float terminationUpdateThreshold, uint maximumNumberOfIterations) => SimpleITK.MultiLabelSTAPLE(image1, image2, image3, image4, image5, labelForUndecidedPixels, terminationUpdateThreshold, maximumNumberOfIterations);
   public static SITKImage MultiLabelSTAPLE(this SITKImage image1, SITKImage image2, SITKImage image3, SITKImage image4, SITKImage image5, LargeUInt labelForUndecidedPixels, float terminationUpdateThreshold, uint maximumNumberOfIterations, VectorFloat priorProbabilities) => SimpleITK.MultiLabelSTAPLE(image1, image2, image3, image4, image5, labelForUndecidedPixels, terminationUpdateThreshold, maximumNumberOfIterations, priorProbabilities);
   public static SITKImage MultiLabelSTAPLE(this SITKImage image1, SITKImage image2, SITKImage image3, SITKImage image4, LargeUInt labelForUndecidedPixels) => SimpleITK.MultiLabelSTAPLE(image1, image2, image3, image4, labelForUndecidedPixels);
   public static SITKImage MultiLabelSTAPLE(this SITKImage image1, SITKImage image2, SITKImage image3, SITKImage image4, LargeUInt labelForUndecidedPixels, float terminationUpdateThreshold) => SimpleITK.MultiLabelSTAPLE(image1, image2, image3, image4, labelForUndecidedPixels, terminationUpdateThreshold);
   public static SITKImage MultiLabelSTAPLE(this SITKImage image1, SITKImage image2, SITKImage image3, SITKImage image4, LargeUInt labelForUndecidedPixels, float terminationUpdateThreshold, uint maximumNumberOfIterations) => SimpleITK.MultiLabelSTAPLE(image1, image2, image3, image4, labelForUndecidedPixels, terminationUpdateThreshold, maximumNumberOfIterations);
   public static SITKImage MultiLabelSTAPLE(this SITKImage image1, SITKImage image2, SITKImage image3, SITKImage image4, LargeUInt labelForUndecidedPixels, float terminationUpdateThreshold, uint maximumNumberOfIterations, VectorFloat priorProbabilities) => SimpleITK.MultiLabelSTAPLE(image1, image2, image3, image4, labelForUndecidedPixels, terminationUpdateThreshold, maximumNumberOfIterations, priorProbabilities);
   public static SITKImage MultiLabelSTAPLE(this SITKImage image1, SITKImage image2, SITKImage image3, LargeUInt labelForUndecidedPixels) => SimpleITK.MultiLabelSTAPLE(image1, image2, image3, labelForUndecidedPixels);
   public static SITKImage MultiLabelSTAPLE(this SITKImage image1, SITKImage image2, SITKImage image3, LargeUInt labelForUndecidedPixels, float terminationUpdateThreshold) => SimpleITK.MultiLabelSTAPLE(image1, image2, image3, labelForUndecidedPixels, terminationUpdateThreshold);
   public static SITKImage MultiLabelSTAPLE(this SITKImage image1, SITKImage image2, SITKImage image3, LargeUInt labelForUndecidedPixels, float terminationUpdateThreshold, uint maximumNumberOfIterations) => SimpleITK.MultiLabelSTAPLE(image1, image2, image3, labelForUndecidedPixels, terminationUpdateThreshold, maximumNumberOfIterations);
   public static SITKImage MultiLabelSTAPLE(this SITKImage image1, SITKImage image2, SITKImage image3, LargeUInt labelForUndecidedPixels, float terminationUpdateThreshold, uint maximumNumberOfIterations, VectorFloat priorProbabilities) => SimpleITK.MultiLabelSTAPLE(image1, image2, image3, labelForUndecidedPixels, terminationUpdateThreshold, maximumNumberOfIterations, priorProbabilities);
   public static SITKImage MultiLabelSTAPLE(this SITKImage image1, SITKImage image2, LargeUInt labelForUndecidedPixels) => SimpleITK.MultiLabelSTAPLE(image1, image2, labelForUndecidedPixels);
   public static SITKImage MultiLabelSTAPLE(this SITKImage image1, SITKImage image2, LargeUInt labelForUndecidedPixels, float terminationUpdateThreshold) => SimpleITK.MultiLabelSTAPLE(image1, image2, labelForUndecidedPixels, terminationUpdateThreshold);
   public static SITKImage MultiLabelSTAPLE(this SITKImage image1, SITKImage image2, LargeUInt labelForUndecidedPixels, float terminationUpdateThreshold, uint maximumNumberOfIterations) => SimpleITK.MultiLabelSTAPLE(image1, image2, labelForUndecidedPixels, terminationUpdateThreshold, maximumNumberOfIterations);
   ...
   public static SITKImage MultiLabelSTAPLE(this SITKImage image1, LargeUInt labelForUndecidedPixels) => SimpleITK.MultiLabelSTAPLE(image1, labelForUndecidedPixels);
   public static SITKImage MultiLabelSTAPLE(this SITKImage image1, LargeUInt labelForUndecidedPixels, float terminationUpdateThreshold) => SimpleITK.MultiLabelSTAPLE(image1, labelForUndecidedPixels, terminationUpdateThreshold);
   public static SITKImage MultiLabelSTAPLE(this SITKImage image1, LargeUInt labelForUndecidedPixels, float terminationUpdateThreshold, uint maximumNumberOfIterations) => SimpleITK.MultiLabelSTAPLE(image1, labelForUndecidedPixels, terminationUpdateThreshold, maximumNumberOfIterations);
   public static SITKImage MultiLabelSTAPLE(this SITKImage image1, LargeUInt labelForUndecidedPixels, float terminationUpdateThreshold, uint maximumNumberOfIterations, VectorFloat priorProbabilities) => SimpleITK.MultiLabelSTAPLE(image1, labelForUndecidedPixels, terminationUpdateThreshold, maximumNumberOfIterations, priorProbabilities);
   public static SITKImage MultiLabelSTAPLE(this VectorOfImage images) => SimpleITK.MultiLabelSTAPLE(images);
   public static SITKImage MultiLabelSTAPLE(this VectorOfImage images, LargeUInt labelForUndecidedPixels) => SimpleITK.MultiLabelSTAPLE(images, labelForUndecidedPixels);
   public static SITKImage MultiLabelSTAPLE(this VectorOfImage images, LargeUInt labelForUndecidedPixels, float terminationUpdateThreshold) => SimpleITK.MultiLabelSTAPLE(images, labelForUndecidedPixels, terminationUpdateThreshold);
   public static SITKImage MultiLabelSTAPLE(this VectorOfImage images, LargeUInt labelForUndecidedPixels, float terminationUpdateThreshold, uint maximumNumberOfIterations) => SimpleITK.MultiLabelSTAPLE(images, labelForUndecidedPixels, terminationUpdateThreshold, maximumNumberOfIterations);
   public static SITKImage MultiLabelSTAPLE(this VectorOfImage images, LargeUInt labelForUndecidedPixels, float terminationUpdateThreshold, uint maximumNumberOfIterations, VectorFloat priorProbabilities) => SimpleITK.MultiLabelSTAPLE(images, labelForUndecidedPixels, terminationUpdateThreshold, maximumNumberOfIterations, priorProbabilities);
   ...
   public static SITKImage RelabelComponent(this SITKImage image1, LargeUInt minimumObjectSize) => SimpleITK.RelabelComponent(image1, minimumObjectSize);
   public static SITKImage RelabelComponent(this SITKImage image1, LargeUInt minimumObjectSize, bool sortByObjectSize) => SimpleITK.RelabelComponent(image1, minimumObjectSize, sortByObjectSize);
